...
const CreateNote = (props) => {
    ...
    return (
        <form className="flex justify-center mb-10">
            <div className="flex flex-col grow lg:grow-0 md:grow-0 sm:grow-0 bg-white m-4 rounded-xl hover:shadow-[0_0_12px_4px_#ccc] border-2 border-zinc-200 w-1/3 p-4 divide-y divide-slate-500 font-medium">
                {isExpanded && (
                    <input
